...
class PedagogicaComplementar
{
    ...
    function recupera($vsDados = array())
    {
        ...
        $vsDados = $this->oConexao->recupera("pedagogica_complementar", $vsDados);
        if ($vsDados)
            return $vsDados;
    ...
    {
        $oConexao = new Conexao();
        $vvDados = $oConexao->recuperaTodos("pedagogica_complementar", $vsDados, $sCampoOrdem);
        return $vvDados;
    }
    ...
    {
        $oConexao = new Conexao();
        $bResultado = $oConexao->presente("pedagogica_complementar", $vsDados);
        return $bResultado;
    }
    ...
    {
        $oConexao = new Conexao();
        $nId = $oConexao->insere("pedagogica_complementar", $vsDados);
        return $nId;
    }
    ...
    {
        $oConexao = new Conexao();
        $bResultado = $oConexao->altera("pedagogica_complementar", $vsDados);
        return $bResultado;
    }
    ...
    {
        $oConexao = new Conexao();
        $bResultado = $oConexao->exclui("pedagogica_complementar", $vsDados);
        return $bResultado;
    }
}
