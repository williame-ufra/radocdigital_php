...
class Campus
{
    ...
    function recupera($vsDados = array())
    {
        ...
        $vsDados = $this->oConexao->recupera("campus", $vsDados);
        if ($vsDados)
            return $vsDados;
    ...
    {
        $oConexao = new Conexao();
        $vvDados = $oConexao->recuperaTodos("campus", $vsDados, $sCampoOrdem);
        return $vvDados;
    }
    ...
    {
        $oConexao = new Conexao();
        $bResultado = $oConexao->presente("campus", $vsDados);
        return $bResultado;
    }
    ...
    {
        $oConexao = new Conexao();
        $nId = $oConexao->insere("campus", $vsDados);
        return $nId;
    }
    ...
    {
        $oConexao = new Conexao();
        $bResultado = $oConexao->altera("campus", $vsDados);
        return $bResultado;
    }
    ...
    {
        $oConexao = new Conexao();
        $bResultado = $oConexao->exclui("campus", $vsDados);
        return $bResultado;
    }
}
